...
### 1. Baseline (Submitted Version) (In older branch)
...
### 2. Extended Version (Exploratory) (In Main branch)
...
Used both as standalone baselines and within ensemble configurations.
...
Rather than searching for a single optimal model, GEFS searches for a set of complementary models, each operating on different feature subsets. This improves robustness under limited or noisy feature spaces.
